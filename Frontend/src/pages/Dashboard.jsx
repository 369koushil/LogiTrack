...
function Dashboard() {
  ...
  // Update Chart and Doughnut Data
  ...
  return (
    <>
      <div className="grid grid-cols-1 col-span-12 lg:col-span-10 gap-6 md:grid-cols-3 lg:grid-cols-4  p-4 ">
        ...
        {/* Additional Articles for Purchase, Products, Stores, etc. */}

        <div className="flex  bg-white rounded-lg py-8 col-span-full justify-around">
          <div>
            <Chart
